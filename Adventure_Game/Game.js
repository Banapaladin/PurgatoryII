...
function Game(){
    ...
    function Temple(){
        ...
        if(temple == "look around" || temple == "look"){
            prompt("descriptive text, yaaaaay");
            Temple();
        }
            ...
            if(templeInspect == "sword"){
                ...
                alert("the tome crumbles to dust in your hands. You couldn’t read the script on the front anyways.");
            }
            else("I don't know what "+templeInspect+" is!")
            Temple();
        }
